export let config = {
  ...
  mockBlockList: [{ firstType: 'select', secondType: 'customer-info-linkage', thirdType: null }],
  ...
  typeDistribution: [
    ...
    { firstType: 'select', sexondType: 'checkbox-tree-select', transform: 'checkbox-tree-select' }, //所属部门树状数据 用到

    {
      firstType: 'select',
      sexondType: 'customer-info-linkage',
      transform: 'customer-info-linkage',
    },
