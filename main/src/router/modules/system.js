...
export default [
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('../../../../NS_system/views/system/systemRolePermission/systemRolePermission'),
      ...
      },
      {
        ...
        component: () => import('../../../../NS_system/views/system/systemOrgEmployee/systemOrgEmployee'),
        meta: {auth: true, key: 'employeeList', title: '设置'},
        name: '组织与员工',
      },
      {
        path: 'systemDataDictionary',
        component: () => import('../../../../NS_system/views/system/systemDataDictionary/systemDataDictionary'),
