...
export default {
  ...
  created() {
    ...
    this.childSelect && choiceRemoteMethod(this, 'customerSearch', this.initDynamicUrl, { ownerId: this.childSelect }, 'post');
  },
  methods: {
    ...
    remoteMethod(query) {
      ...
      if (this.remoteSW && this.dynamicUrl && query !== '') {
        ...
        choiceRemoteMethod(this, 'customerSearch', this.dynamicUrl, params, 'post');
      } else {
