...
<script>
  ...
  import {distributor} from '@NEAP/mainstay/utils/validate/index';
  import {config} from './config';
  import {judgeType, isXType, arrContainObj, strContainPlace} from '../../../utils/index';
    ...
    computed: {
      ...
      labelWidthConvert() {
        ...
        /*
          ...
          */
        return isXType('string', this.labelWidth)
          ? this.labelWidth
          : isXType('number', this.labelWidth)
      ...
      isValidating() {
        ...
        if (this.arrContainObj(this.noValidateList, this.itemType)) {
          ...
          if (this.required || this.rules) {
            return (
              arrContainObj(checkList, checkKey) ||
              arrContainObj(checkList, 'all-check')
            );
          } else {
            return false;
          }
