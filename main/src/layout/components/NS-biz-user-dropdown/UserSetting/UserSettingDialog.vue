<template>
  ...
  >
    ...
    <!--&lt;!&ndash;<div>性别：<span>{{userInformation.userSex}}</span></div>&ndash;&gt;-->
    <!--</div>-->
    <!--</div>-->
    <!--</div>-->
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters(['userinfo', 'requestHead']),
    ...
    methods: {
       ...
       */
      getUserInfo() {
        getUserInfo({ userId: this.userinfo.userId, appId: this.requestHead.appId }).then((res) => {
