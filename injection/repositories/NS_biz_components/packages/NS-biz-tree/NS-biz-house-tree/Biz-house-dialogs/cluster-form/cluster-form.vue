...
<script>
  import resetData from './cluster-form.js';
  ...
  export default {
    ...
    data() {
      return {
        ...
        //============= auto form ==============
        autoFormID: 'house-tree-cluster-form', //表单唯一ID值
        showMessage: false,
          ...
          resourcefieldBindingfnList: {
            houseName: params => {
              ...
              if (params.type === 'change') {
                params.formData.modelData.clusterShortName = params.formData.modelData.houseName;
              }
            },
          },
          dynamicQuery: {},
